...
import bhutan_contact from "../../assets/vijay_daju.jpeg";
...
function ContactUsCard({ modalHidden, hideModal }) {
        ...
        <>
            <div className='md:max-w-lg h-fit flex flex-row items-center justify-center bg-[#FFFBFB] rounded-lg shadow-xl'>
                <div className="flex flex-col items-center justify-center">
                    <div className="py-8">
                        <h1 className="text-center md:text-left text-2xl font-bold text-gray-900">Contact In Bhutan</h1>
                    </div>
                    <div className="flex flex-col md:flex-row w-3/4 md:w-5/6 space-x-0 md:space-x-8">
                        <div className="mb-4 w-full md:w-2/5 flex flex-col items-center justify-center">
                            <div className="w-1/2 md:w-full rounded-full overflow-hidden">
                                <img src={bhutan_contact} alt="woman wearing a headwrap and an Africa-shaped earring while smiling" />
                            </div>
                        </div>
                    ...
                    <div className="w-full py-8 flex items-center justify-center space-x-8">
