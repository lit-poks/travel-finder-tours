                ...
                <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    <div className="md:flex md:justify-between">
                        ...
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            ...
                            <div>
                                <h2 className="mb-6 text-sm font-semibold uppercase text-white">Partners </h2>
                                <ul className="text-gray-400 font-medium">
                                    <li className="mb-4">
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm sm:text-center text-gray-400">© 2023 <a href="#" className="hover:underline">Travel Finder Tours</a>. All Rights Reserved.
                        </span>
                        <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                            <a href="https://www.facebook.com/profile.php?id=100088179842340&mibextid=LQQJ4d" target='_blank' className="text-gray-500 hover:text-white">
                                <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                                    <path fill-rule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clip-rule="evenodd" />
                                </svg>
                                <span className="sr-only">Facebook page</span>
                            </a>
                            <a href="https://instagram.com/travel_finder_tours?igshid=OGQ5ZDc2ODk2ZA==" target='_blank' className="text-gray-500 hover:text-white">
                            ...
                            <a href="http://www.tiktok.com/@travelfindertours_bhutan" target='_blank' className="text-gray-500 hover:text-white">
                            ...
                            <a href="https://wa.me/+97517937798" target='_blank' className="text-gray-500 hover:text-white">
